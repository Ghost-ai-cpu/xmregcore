...
{
    // setup worktips logger for minimum output
    ...
    {
        // use Worktips donation address and viewkwey
        ...
        cout << "Worktips donation account: " << *account << '\n';
...

    {
        ...
        cout << "Worktips forum donation account: " << *primary_account << '\n';
        ...
        if (!outputs_found.empty())
        {
            ...
            // proposal https://ccs.getworktips.org/proposals/xiphon-part-time.html
        }
    }
...

    {
        ...
        cout << "Worktips formum donation account: " << *primary_account << '\n';
        ...
        if (tx->vin.size() == inputs_found.size())
        {
            ...
            cout << "Possible spending from Worktips fourm donation is: " 
                 << print_money(possible_total_spent) << " xmr\n";
        }
    }
